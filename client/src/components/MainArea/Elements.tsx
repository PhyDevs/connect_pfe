...
export const WelcomeWrapper = styled.section<WelcomeWrapperProps>`
	display: flex;
	margin: 0;
	margin-bottom: 10px;
	flex-grow: 1;
...
export const MessagesWrapper = styled.section<MessagesWrapperProps>`
	display: flex;
...
export const BigTitle = styled.div<BigTitleProps>`
	margin-top: -50px;
	text-align: center;
	h1 {
		margin-bottom: 10px;
...
export const ChatForm = styled.div<ChatFormProps>`
	width: calc(100% - 40px);
	margin: 0 20px 30px;
	padding: 30px 10px 0;
